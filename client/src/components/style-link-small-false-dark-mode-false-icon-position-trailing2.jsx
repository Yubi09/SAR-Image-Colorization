...
const StyleLinkSmallFalseDarkModeFalseIconPositionTrailing2 = ({
  className = "",
}) => {
  return (
    <div
...
StyleLinkSmallFalseDarkModeFalseIconPositionTrailing2.propTypes = {
  className: PropTypes.string,
};

export default StyleLinkSmallFalseDarkModeFalseIconPositionTrailing2;
