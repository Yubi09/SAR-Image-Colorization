...
const Frame = () => {
	...
	return (
		<div className="w-full relative h-[244vw] overflow-hidden xxsm:bg-[url('Frame_6.png')] xsm:bg-[url('Frame_3.png')] bg-cover bg-no-repeat bg-[top] flex gap-0 text-center text-base text-border-alternate font-heading-desktop-h5 hover:flex hover:w-full xxsm:h-[350vh] ism:h-[400vh]">
			<div className="absolute xxsm:top-[10vw] xxsm:left-[5vw] xxsm:w-[39vw] xxsm:h-[73vw] flex flex-col items-start justify-start gap-6 text-left text-37xl">
				...
				<div className="flex flex-row items-start justify-start xxsm:pt-0 md:pt-4 px-0 pb-0">
					<div className="rounded-lg border-border-alternate border-[1px] border-solid flex flex-row items-center justify-center xxsm:py-2 xxsm:px-4 md:py-3 md:px-6">
						<Link
							className="cursor-pointer [border:none] p-0 bg-[transparent] relative text-base leading-[150%] font-roboto xxsm:text-[9px] md:text-[12px] text-border-alternate text-left inline-block no-underline"
				...
				<div>
					...
					<div className="absolute top-[25px] xxsm:left-[65vw] lg:left-[76vw] rounded-[32px] flex flex-row items-center justify-end">
						<div className="rounded-26xl border-border-alternate border-[3px] border-solid flex flex-row items-center justify-center xxsm:py-1 xxsm:px-3 md:py-2 md:px-5">
							<Link
								className="cursor-pointer [border:none] p-0 bg-[transparent] relative xxsm:text-[12px] md:text-base leading-[150%] font-bold font-heading-desktop-h5 text-border-alternate text-left inline-block no-underline"
								disabled={true}
