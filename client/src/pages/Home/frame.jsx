...
const Frame = () => {
	...
	const handleConvertNow = () => {
		navigate(loggedInUser ? "/landing" : "/login");
	};
	...
	const handleLoginOrDash = () => {
		navigate(loggedInUser ? "/dashboard" : "/login");
	};
	...
	return (
		<div className="w-full relative xsm:h-[244vw]  overflow-hidden xxsm:bg-[url('Frame_6.png')] xsm:bg-[url('Frame_3.png')] bg-cover bg-no-repeat bg-[top] flex gap-0 text-center text-base text-border-alternate font-heading-desktop-h5 hover:flex hover:w-full xxsm:h-[350vh] ism:h-[400vh]">
			<div className="absolute xxsm:top-[10vw] xxsm:left-[5vw] xxsm:w-[39vw] xxsm:h-[73vw] flex flex-col items-start justify-start gap-6 text-left text-37xl">
				<div className="self-stretch flex flex-col items-start justify-start xxsm:gap-3 md:gap-6">
					...
					<h4 className="m-0 self-stretch relative xxsm:text-[12px] xsm:text-[9px] md:text-[11px] lg:text-base xl:text-lg leading-[150%] font-normal font-[inherit]">
						Experience the power of color in SAR images like never
						before.
					</h4>
				</div>
				<div className="cursor-pointer flex flex-row items-start justify-start xxsm:pt-0 md:pt-4 px-0 pb-0 z-50">
					<button
						onClick={handleConvertNow}
						className="cursor-pointer p-0 rounded-lg border-border-alternate border-[1px] border-solid flex flex-row items-center justify-center xxsm:py-2 xxsm:px-4 md:py-3 md:px-6 bg-transparent text-base  leading-[150%] font-roboto xxsm:text-[9px] md:text-[16px] text-border-alternate text-left inline-block"
					>
						Convert Now
					</button>
				</div>
			...
			{!loggedInUser && (
				<div className="cursor-pointer absolute top-[25px] xxsm:left-[10vw] xsm:left-[80vw] lg:left-[86vw] rounded-26xl border-border-alternate border-[3px] border-solid flex flex-row items-center justify-center xxsm:py-1 xxsm:px-3 md:py-2 md:px-5 z-50">
					<button
						onClick={handleSignUp}
						className="cursor-pointer p-0 bg-transparent relative xxsm:text-[12px] md:text-base leading-[150%] font-bold font-heading-desktop-h5 text-border-alternate text-left inline-block"
					>
						Sign Up
					</button>
				</div>
			...
			<div className="cursor-pointer absolute top-[25px] xxsm:left-[65vw] lg:left-[76vw] rounded-26xl border-border-alternate border-[3px] border-solid flex flex-row items-center justify-center xxsm:py-1 xxsm:px-3 md:py-2 md:px-5 z-50">
				<button
					onClick={handleLoginOrDash}
					className="cursor-pointer p-0 bg-transparent relative xxsm:text-[12px] md:text-base leading-[150%] font-bold font-heading-desktop-h5 text-border-alternate text-left"
				>
					{loggedInUser
					...
					<div className="self-stretch flex flex-col items-start justify-start gap-4">
						...
						<div className="self-stretch flex flex-col items-start justify-start gap-6 text-left xxsm:text-[16px] md:text-[25px] lg:text-29xl">
							<b className="self-stretch relative leading-[120%] xxsm:text-center xsm:text-left xxsm:top-[75vh] xsm:top-[0vw] md:top-[0vw] lg:top-[58vw]">
								Revolutionize SAR Image Colorization Technology
							...
							<div className="self-stretch relative xxsm:top-[75vh] xsm:top-[0vw] md:top-[0vw] lg:top-[58vw] xxsm:text-[12px] iism:text-[15px] ism:text-[18px] xsm:text-[10px] md:text-[15px] lg:text-lg leading-[150%] xsm:text-left xxsm:text-center">
								Our cutting-edge SAR Image Colorization
								technology utilizes advanced algorithms to bring
								vibrant colors to black and white images. With
								our innovative solution, you can now transform
								your SAR images into stunning visual
								representations, enabling better analysis and
								interpretation.
							</div>
						</div>
					</div>
			...
			<img
				...
				className="absolute xxsm:top-[212vh] xsm:top-[135vw] xxsm:left-[7vw] xxsm:w-[30vw] xxsm:h-[37vw]"
			/>
			<img
				src={"/home_output_img.jpg"}
				className="absolute xxsm:top-[212vh] xsm:top-[135vw] xxsm:left-[63vw] bg-border-default-default xxsm:w-[30vw] xxsm:h-[37vw]"
			/>
			...
			<div className="absolute xxsm:top-[240vh] ism:top-[250vh] xsm:top-[181vw] xxsm:left-[5vw] xxsm:w-[91vw] flex flex-row items-start justify-start gap-[20px] text-right text-91xl text-text-primary">
				<div className="flex-1 overflow-hidden flex flex-col items-start justify-start text-left text-21xl">
					<b className="self-stretch relative leading-[120%] xxsm:text-[10px] ism:text-[20px] xsm:text-[15px] sm:text-[20px] lg:text-[30px] xl:text-[50px]  xxsm:m-0 xxsm:p-0">
						Transform your black-and-white SAR images into vibrant,
						colorized masterpieces
					</b>
				</div>
				<b className="relative leading-[120%] xxsm:text-[30px] md:text-[50px] lg:text-[70px]">
					|
				</b>
				<div className="flex-1 overflow-hidden flex flex-col items-start justify-start">
					<b className="self-stretch relative leading-[120%] xxsm:text-[20px] xsm:text-[30px] ism:text-[35px] md:text-[50px] lg:text-[70px] xl:text-[90px]">
						About Us
					</b>
				</div>
			</div>
			<div className="absolute xxsm:top-[280vh] ism:top-[300vh] xsm:top-[197vw] xxsm:left-[5vw] xxsm:w-[91vw] xxsm:h-[15vw] md:h-[22vw] flex xxsm:flex-col xsm:flex-row items-start justify-center xxsm:gap-6 xsm:gap-12 text-left text-text-primary xxsm:pt-0 xsm:pt-2 sm:pt-6">
				<div className="flex-1 flex flex-col items-start justify-start xxsm:gap-3 md:gap-6">
					...
					<b className="self-stretch relative xxsm:text-[13px] md:text-[18px] lg:text-5xl leading-[140%]">
						Securely handle your sensitive SAR images with
						confidence
					</b>
					<div className="self-stretch relative leading-[150%] xxsm:text-[9px] md:text-[16px]">
						Our platform employs state-of-the-art security measures
				...
				<div className="flex-1 flex flex-col items-start justify-start xxsm:gap-3 md:gap-6">
					...
					/>
					<b className="self-stretch relative xxsm:text-[13px] md:text-[18px] lg:text-5xl leading-[140%]">
						Effortlessly manage your colorization projects with our
						intuitive dashboard
					</b>
					<div className="self-stretch relative xxsm:text-[9px] md:text-[16px] leading-[150%]">
						Track the progress of your images and easily access your
						colorized results
					</div>
					<div className="self-stretch flex flex-col items-start justify-start pt-2 px-0 pb-0 font-roboto">
						<div className="flex flex-row items-center justify-center gap-2"></div>
				...
				<div className="flex-1 flex flex-col items-start justify-start xxsm:gap-3 md:gap-6">
					...
					/>
					<b className="self-stretch relative xxsm:text-[13px] md:text-[18px] lg:text-5xl leading-[140%]">
						Experience the power of SAR image colorization for
						yourself
					</b>
					<div className="self-stretch relative xxsm:text-[9px] md:text-[16px] leading-[150%]">
						Unlock a new level of visual insight with our
