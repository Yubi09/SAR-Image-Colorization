...
const StyleLinkSmallFalseDarkModeFalseIconPositionTrailing1 = ({
  className = "",
}) => {
  return (
    <div
...
StyleLinkSmallFalseDarkModeFalseIconPositionTrailing1.propTypes = {
  className: PropTypes.string,
};

export default StyleLinkSmallFalseDarkModeFalseIconPositionTrailing1;
