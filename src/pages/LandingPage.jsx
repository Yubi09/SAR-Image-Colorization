...
export const LandingPage = () => {
    return (
      <div className="w-full relative h-[1847px] overflow-hidden bg-[url('/public/frame-4@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-16xl text-border-alternate font-text-regular-normal">
        ...
        <div className="absolute top-[1453px] left-[826px] w-[391px] h-[89px]">
          ...
          <b className="absolute top-[16px] left-[138px] inline-block w-[139.1px] h-[33.9px]">
            Submit
          </b>
        </div>
